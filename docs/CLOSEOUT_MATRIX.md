...
| 事实面 | 状态 | 当前答案与证据入口 |
| --- | --- | --- |
| 代码与路由 | changed-and-verified | FastAPI `main.py`、`app/`、`schemas/`、`frontend/`；阶段 31E 已整合作品拆解工作区；当前 58/61，全站旧 `/novel` 16/19。 |
...
| 自动化门禁 | changed-and-verified | 当前候选集成 133 tests、0 failed、0 skipped；compileall、node check、diff check、OpenAPI、canonical API 与本地浏览器烟雾均已复核。 |
